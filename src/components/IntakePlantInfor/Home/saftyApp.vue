...
<html>
 ...
 <div id="header">
		...
		<div class="right_nav">
			<ul>
				<li class="nav_li" id="r_fw"><router-link to="/saftyApp"><img  src="./img/nav_z.png" class="nav_image"/> 消纳场监测</router-link> </li>
  ...
  <div id="app">
    ...
    <Menu v-show="true"  :appconsumers="appconsumers" :viewer="viewer" />
    <!-- <router-view /> -->
    <!-- <div v-show="!viewer" class="loadingOverlay">Loading...</div> -->
   <div id="cesiumContainer1" class="div3">
   </div>
