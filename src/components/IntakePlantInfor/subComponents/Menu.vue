...
<template>
 <!-- <div class="div2" id="div2" v-cloak> -->
...
<!--         
        <ul  id="div2_div1" class="div2_div1">
            
                <li @click=showBaseMesg class="div2_div1_p">基本信息</li>
                <li @click=showQuery   class="div2_div1_p">信息查询</li>
                <li @click=showChart  class="div2_div1_p"><router-link style="color:white" to="/statGraph ">基本统计</router-link></li>
                 <li @click=test   class="div2_div1_p">测试</li>
        </ul> -->
...
addLatLonIndex(longtitude,latitude){
   ...
   console.log(latitude)
    ...
    billboard : {
        image : '/static/Image/apoint4.png',
        width:32,
        height:32
    },
    })
