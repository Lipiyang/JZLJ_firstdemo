    ...
    <div id="app">
		...
		<div id="content" >
			...
			<div id="right" class="container">
				...
				<div id="companyinfo">
					<div>
						<label style="color:white" >公司名称：</label>
						...
						<label style="color:white">联系人：</label>
					...
					<div style="overflow:auto;">
						...
						<VPagination style="color:white" :total="total" @page-change="pageChange1" @page-size-change="pageSizeChange1" :pageSize="pageSize" :pageSizeOption="pageSizeOption"></VPagination>
					</div>
				...
				<div id="carinfo" style="display:none">
					<div>
						<label style="color:white">车辆编号：</label>
					...
					<div>
						...
						<VPagination style="color:white" :total="total_car" @page-change="pageChange1_car" @page-size-change="pageSizeChange1_car" :pageSize="pageSize_car" :pageSizeOption="pageSizeOption_car"></VPagination>
					</div>
					<!-- <model :list='selectedlist' :isactive="isActive" v-cloak @change="changeOverlay" @modify="modify"></model> -->
				</div>
		...
		<div class="overlay" v-show="isActive_car">
			...
			<h2 class="title">车辆信息： 新增 | 修改</h2>
				<div class="content_c">
					...
					<br>
                	<p style="text-align:center;">
                        <input type="button"  value="取消" @click="cancel_car()">
                        <input type="button"  value="保存" @click="save_car()">
                    </p>
				</div>
			</div>
		</div>
